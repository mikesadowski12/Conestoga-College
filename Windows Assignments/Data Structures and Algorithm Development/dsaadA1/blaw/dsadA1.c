...
// into a linked list called StudentHead, and prints both lists afterwards. Both linked lists are sorted by the student's real name. After it has made both of the lists, the program then scans each subdirectory for the student's
...
void PrintStudentLinkedList(Student* StudHead);
void PrintNicknameLinkedList(Nickname* NickHead);
...
int main(void)
{
	...
	PrintNicknameLinkedList(NicknameHead);
	PrintStudentLinkedList(StudentHead);
...
// Function: PrintStudentLinkedList
// Description: This function prints the Student Linked List
// Parameters: Parameter 1 - head pointer to the Student Linked List
// Return Value: None
void PrintStudentLinkedList(Student* StudHead)
{
	Student *current = StudHead;

	printf("\nStudent Linked List: \n");
	do
	{
		printf("%s, %s, %s\n", current->StudentName, current->NickName, current->DirectoryName);
...
// Description: This function prints the Nickname Linked List
// Parameters: Parameter 1 - head pointer to the Nickname Linked List
// Return Value: None
void PrintNicknameLinkedList(Nickname* NickHead)
{
	Nickname *current = NickHead;

	printf("\nNickname File Linked List: \n");
	do
	{
		printf("%s, %s\n", current->RealName, current->NickName);
